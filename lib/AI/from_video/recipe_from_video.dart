...
import 'package:aikitchen/services/gemini_video_service.dart';
...
class _RecipeFromVideoState extends State<RecipeFromVideo> {
  ...
  Future<void> _generateFromVideo() async {
    ...
    if (apiKey == null || apiKey.isEmpty) {
      Toaster.showError('Necesitas configurar tu API Key de Gemini en Ajustes');
      return;
    }
    ...
    try {
      final service = GeminiVideoService(apiKey: apiKey);
